...
const Indrayani_History = () => {
  return (
    <div className="history-container">
        <h1 className="center">Indrayani Temple</h1>
        
        <div className="card">
            <div className="left">
                <img src={indrayani} alt="Indrayani Temple" />
            </div>
            <div className="right_ind">
                <strong>Name:</strong> Indrayani Temple<br/>
                <strong>Alternative names:</strong> Lhuti Maru Ajima Temple, Lunti Ajima, Luntimaru<br/>
                <strong>Location:</strong> P873+H2J, Kathmandu 44600<br/>
                <strong>Time:</strong> Open 24 hours<br/>
            </div>
        </div>
        
        <h2>History of Indrayani</h2>
        <p>
...
export default Indrayani_History;